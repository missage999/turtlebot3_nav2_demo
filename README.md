...
### 9.9 model.sdf中坐标轴的旋转方向问题
**问题**：关节的旋转方向和visual以及collision的旋转方向定义会导致旋转轴坐标基准不一样，所以旋转轴不同  
**解决**：[解释](https://www.kimi.com/share/19aa652f-4402-84b0-8000-0000302c2602)，关节的顶层pose会改变坐标系，而visual和collision的pose不会